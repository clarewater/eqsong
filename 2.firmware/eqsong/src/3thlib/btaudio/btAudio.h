...
public:
	...
	// I2S Audio
	void I2S(int mck, int bck, int dout, int ws);
	...
	void setDSP_iir_left(
		uint8_t numStages,
		float32_t *pCoeffs,
		float32_t *pState);
	void setDSP_iir_right(
		uint8_t numStages,
		float32_t *pCoeffs,
		float32_t *pState);
	// meta data
	...
	static String album;
	static String genre;
	static arm_biquad_casd_df1_inst_f32 s_left;
	static arm_biquad_casd_df1_inst_f32 s_right;
